...
const FilterPanel = ({ isFilterPanelOpen, setIsFilterPanelOpen }) => {
  ...
  return (
    <div
      className={`bg-gray-100 z-20 absolute top-0 left-0 p-3 w-full md:w-72 h-full rounded-lg transition-transform duration-300 ${
